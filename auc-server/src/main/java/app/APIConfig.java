...
public class APIConfig implements WebMvcConfigurer {
    ...
    @Value("${jwt.passphrase:redouan redouan redouan redouan redouan redouan redouan redouan redouan redouan redouan redouanThis is very secret information for my private encryption key.}")
    private String passphrase;

    @Value("${jwt.duration-of-validity:200}") // default 20 minutes;
